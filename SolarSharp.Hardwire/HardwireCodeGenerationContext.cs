...
namespace SolarSharp.Hardwire
{
    ...
    public sealed class HardwireCodeGenerationContext
    {
        ...
        private readonly Stack<string> m_NestStack = new();
            ...
            HardwireCodeGenerationLanguage language)
        {
            ...
            Comment("----------------------------------------------------------");
            Comment("Generated by SolarSharp.Hardwire v.{0}", Assembly.GetExecutingAssembly().GetName().Version);
            Comment("Compatible with SolarSharp v.{0} or equivalent", LuaState.VERSION);
            Comment("----------------------------------------------------------");
