...
namespace SolarSharp.Hardwire.Languages
{
    ...
    public class VbNetHardwireCodeGenerationLanguage : HardwireCodeGenerationLanguage
    {
        ...
        /// <inheritdoc />
        public override CodeDomProvider CodeDomProvider { get; } = CodeDomProvider.CreateProvider("VisualBasic");
        ...
        public override CodeExpression CreateMultidimensionalArray(string type, CodeExpression[] args)
        {
            ...
            var dimensionExpressions = args.Select(e => 
                SnippetExpression("{0} - 1", e)).ToArray();
