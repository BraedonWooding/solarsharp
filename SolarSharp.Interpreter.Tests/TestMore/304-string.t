...
-- SolarSharp : this commented out as it might fail mostly because of CRLF in windows than because of 
-- a SolarSharp bug I think. Will see, surely not a blocking issue now.
--[==[ 
