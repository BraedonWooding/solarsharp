...
internal class Lexer
{
        ...
        switch (c)
        {
            ...
            case '=':
                return PotentiallyDoubleCharOperator('=', TokenType.Op_Assignment, TokenType.Op_Equal, fromLine,
                    fromCol);
            case '<':
                return PotentiallyDoubleCharOperator('=', TokenType.Op_LessThan, TokenType.Op_LessThanEqual, fromLine,
                    fromCol);
            case '>':
    ...
    private Token CreateNameToken(string name, int fromLine, int fromCol)
    {
        ...
        if (reservedType.HasValue) return CreateToken(reservedType.Value, fromLine, fromCol, name);
