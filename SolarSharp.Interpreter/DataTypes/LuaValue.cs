...
///     Note: we may have to do some unsafe stuff like; https://stackoverflow.com/a/72507955 to make *some* writes
///     performant
...
public struct LuaValue
{
    ...
    /// </summary>
    [FieldOffset(0)] public object LightUserDataValue;
    ...
    ///     Standard lua table
    /// </summary>
    [FieldOffset(0)] public Table TableValue;
    ...
    /// </summary>
    [FieldOffset(0)] public Closure FunctionValue;

    /// <summary>
    ///     User data.
    /// </summary>
    [FieldOffset(0)] public UserData UserDataValue;

    /// <summary>
    ///     A coroutine
    /// </summary>
    [FieldOffset(0)] public Coroutine ThreadValue;

    /// <summary>
    ///     The type of lua value
    ///     In future I'm planning on using a NaN tagged value (potentially) to get better performance
    /// </summary>
    [FieldOffset(8)] public LuaDataType Type;
