...
public abstract class ScriptLoaderBase : IScriptLoader
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether the LUA_PATH global is checked or not to get the path where modules are
    ///     contained.
    ...
    public static string[] GetDefaultEnvironmentPaths()
    {
        ...
        if (modulePaths == null)
        {
            var env = Script.GlobalOptions.Platform.GetEnvironmentVariable("SOLARSHARP_PATH");
