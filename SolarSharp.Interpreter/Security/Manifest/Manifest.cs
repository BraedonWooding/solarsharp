...
namespace SolarSharp.Interpreter.Security.Manifest
{
    ...
    public class ManifestSecurity
    {
        ...
        public AsymmetricAlgorithm GetPublicKey()
        {
            ...
            if (CertificateChain != null && CertificateChain.Count > 0)
            {
                ...
                var certificate = new System.Security.Cryptography.X509Certificates.X509Certificate2(
                    System.Text.Encoding.UTF8.GetBytes(leafCertPem));
        ...
        {
            return Certificate != null || (CertificateChain != null && CertificateChain.Count > 0);
        }
    }
    ...
    public class ManifestPolicy
    {
        ...
        [JsonPropertyName("preventDynamicCode")]
        ...
        public SecurityConfigurationOverrides ToSecurityOverrides()
        {
            ...
            {
                overrides.DefaultFileAccess = DefaultFileAccess.ParseFileAccess();
            }
            ...
            {
                overrides.FilePermissions = FilePermissions.ToDictionary(
                    kvp => kvp.Key,
                    kvp => kvp.Value.ParseFileAccess()
                );
            }

            if (DirectoryPermissions != null)
            {
                overrides.DirectoryPermissions = DirectoryPermissions.ToDictionary(
                    kvp => kvp.Key,
                    kvp => kvp.Value.ParseDirectoryAccess()
                );
            }
            ...
            if (AntiPolymorphism.HasValue && AntiPolymorphism.Value)
            {
                ...
                overrides.PreventDynamicCode = true;
            ...
            else
            {
                ...
                if (PreventDynamicCode.HasValue)
                    overrides.PreventDynamicCode = PreventDynamicCode.Value;
            }
        ...
        private CoreModules ParseModules(List<string> modules)
        {
        ...
        private ScriptCapabilities ParseCapabilities(List<string> capabilities)
        {
        ...
        /// <summary>
        /// Converts this ManifestPolicy to a SecurityConfiguration
        /// </summary>
        /// <returns>A SecurityConfiguration with this policy's settings applied</returns>
        public SecurityConfiguration ToSecurityConfiguration()
        {
            var config = SecurityConfiguration.CreateIsolated();
            var overrides = ToSecurityOverrides();
            return overrides.ApplyTo(config);
        }
    }
    ...
    public enum TrustLevel
    {
        ...
        /// <summary>
        /// Manifest has a signature but not from a trusted key - can only make security more restrictive
        /// </summary>
        Untrusted = 1,
