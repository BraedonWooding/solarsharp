...
namespace SolarSharp.Interpreter.Security
{
    ...
    public class InteropSecurity
    {
        ...
        /// </summary>
        public bool AllowTypeRegistration { get; set; }

        /// <summary>
        /// Whether to allow access to static members
        /// </summary>
        public bool AllowStaticAccess { get; set; }
        ...
        /// </summary>
        public static InteropSecurity NoAccess() =>
            new InteropSecurity
            {
        ...
        /// </summary>
        public static InteropSecurity SafeTypesOnly() =>
            new InteropSecurity
            {
        ...
        /// </summary>
        public static InteropSecurity FullAccess() =>
            new InteropSecurity
            {
                DefaultAccessMode = InteropAccessMode.Reflection,
