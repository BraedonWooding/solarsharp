...
namespace SolarSharp.Interpreter.Security.Manifests
{
    ...
    public class ManifestBuilder
    {
        ...
        {
            EnsurePolicy();
            _manifest.Policy.TimeoutMs = milliseconds;
            return this;
        }
        ...
        public ManifestBuilder AddFileRule(string scope, FilePermissions access)
        {
        ...
        public ManifestBuilder AddDirectoryRule(string scope, DirectoryPermissions permissions)
        {
            AddRule(scope, RuleTarget.File, new ComposableManifestRule
            {
                Scope = scope,
        ...
        public ManifestBuilder WithDefaultFileAccess(FilePermissions access)
        {
            EnsurePolicy();
        ...
        public ManifestBuilder WithDefaultDirectoryAccess(DirectoryPermissions permissions)
        {
            EnsurePolicy();
            _manifest.Policy.DefaultDirectoryAccess = permissions.ToManifestString();
            return this;
        }
        ...
        public ManifestBuilder WithAntiPolymorphism(bool enable = true)
        {
            ...
            if (enable)
            {
                ...
                _manifest.Policy.PreventRunString = true;
                _manifest.Policy.PreventInternalDynamicCode = true;
