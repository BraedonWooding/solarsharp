...
internal static class TypeDescriptorRegistry
{
    ...
    internal static void RegisterAssembly(Assembly asm = null, bool includeExtensionTypes = false)
    {
        ...
        if (includeExtensionTypes)
        {
            ...
            foreach (var extType in extensionTypes) UserData.RegisterExtensionType(extType.DataType);
        }
    ...
    /// <returns></returns>
    internal static IUserDataDescriptor RegisterProxyType_Impl(IProxyFactory proxyFactory, InteropAccessMode accessMode,
        string friendlyName)
    {
    ...
    /// <returns></returns>
    internal static IUserDataDescriptor RegisterType_Impl(Type type, InteropAccessMode accessMode, string friendlyName,
    ...
    internal static InteropAccessMode ResolveDefaultAccessModeForType(InteropAccessMode accessMode, Type type)
    {
        ...
        {
            var attr = Framework.Do.GetCustomAttributes(type, true).OfType<SolarSharpUserDataAttribute>()
                .SingleOrDefault();
