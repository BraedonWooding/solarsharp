...
public static class DescriptorHelpers
{
    ...
    ///     <see cref="SolarSharpVisibleAttribute" /> or a <see cref="SolarSharpHiddenAttribute" />  is changing visibility of
    ///     a member
    ///     to scripts.
    /// </summary>
    ...
    ///     If both SolarSharpHiddenAttribute and SolarSharpVisibleAttribute are
    ...
    public static bool? GetVisibilityFromAttributes(this MemberInfo mi)
    {
        ...
        var va = mi.GetCustomAttributes(true).OfType<SolarSharpVisibleAttribute>().SingleOrDefault();
