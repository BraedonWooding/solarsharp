...
do
  ...
  local result = string.format("stretch tree of depth %d\t check: %d\n",
...
for depth=mindepth,maxdepth,2 do
  ...
  local result = string.format("%d\t trees of depth %d\t check: %d\n",
    iterations, depth, check)
end

local result = string.format("long lived tree of depth %d\t check: %d\n",
